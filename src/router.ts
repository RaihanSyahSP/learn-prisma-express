...
router.put("/update/:id", body("title").optional(), body("body").optional(), body("status").isIn(["IN_PROGRESS", "SHIPPED", "DEPRECEATED"]).optional(), body("version").optional(), updateUpdate);
